...
# Local imports
from src.custom_layers import PoolHelper
...
class LengthModel():
    ...
    def train_evaluate_model(self, model, x_train, y_train, x_val, y_val, x_test, y_test):
        ...
        model_checkpoint = ModelCheckpoint(
            filepath='../lib/models/checkpoints/best_length_model.h5', monitor='val_loss', save_best_only=True)
        ...
        model.save('../lib/models/length_mix4.h5')
