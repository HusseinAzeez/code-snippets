...
class LengthModel():
    ...
    def create_model(self, input_shape):
        ...
        conv1_5x5_s1 = Convolution2D(6, kernel_size=(
            5, 5), strides=1, padding='same', activation='relu', name='conv1/5x5_s1')(img_shape)
    ...
    def train_evaluate_model(self, model, x_train, y_train, x_val, y_val, x_test, y_test):
        ...
        tensor_board = TensorBoard(
            log_dir='./models/Graph', histogram_freq=0, write_graph=True, write_images=True)
        ...
        model_checkpoint = ModelCheckpoint(
            filepath='./models/checkpoints/length_model.h5', monitor='val_loss', save_best_only=True)
        ...
        model.save('./models/length_mix2.h5')
